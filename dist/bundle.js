(() => {
    ...
    const y = function setInitData(e) {
        for (var t = e.teams, y = 0; y < t.length; y++) {
            var p = t[y], g = p.sid, m = p.owner, h = new n(new r(m), g);
            _.teams.push(h);
        }
    };
    ...
    const g = function addPlayer(e, t) {
        var n = _.GamePlayerManager.getPlayerBySid(e[1]);
        n || ((n = new r(e[1])).name = e[2], n.id = e[0], _.GamePlayerManager.addPlayer(n)), 
        _.debug("Player " + n.name + " has joined the game."), t && console.log("You are now in game!");
    };
    const m = function removePlayer(e) {
        _.GamePlayerManager.removePlayerById(e), _.debug("Player " + e + " has left the game.");
    };
    const h = function chunk(e, t) {
        for (var n = [], r = 0; r < e.length; r += t) n.push(e.slice(r, r + t));
        return n;
    };
    const b = function isElementVisible(e) {
        return null !== e.offsetParent;
    };
    const P = function cacheItems() {
        _.myPlayer.inventory = {};
        for (var e = 0; e < 9; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.primary = e);
        for (e = 9; e < 16; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.secondary = e);
        for (e = 16; e < 19; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.food = e - 16);
        for (e = 19; e < 22; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.wall = e - 16);
        for (e = 22; e < 26; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.spike = e - 16);
        for (e = 26; e < 29; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.mill = e - 16);
        for (e = 29; e < 31; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.mine = e - 16);
        for (e = 31; e < 33; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.boostPad = e - 16, 
        _.myPlayer.inventory.trap = e - 16);
        for (e = 33; e < 39; e++) b(document.getElementById("actionBarItem" + e.toString())) && 36 != e && (_.myPlayer.inventory.turret = e - 16);
        for (_.myPlayer.inventory.spawnPad = 36, e = 36; e < 37; e++) b(document.getElementById("actionBarItem" + e.toString())) && (_.myPlayer.inventory.spawnPad = e - 16);
    };
    ...
    const j = function loadGameObject(e) {
        h(e, 8).forEach((function(e) {
    ...
    const k = function() {
        ...
        return Leaderboardmanager.prototype.updateLeaderboard = function(e) {
            ...
            n.forEach((function(e, n) {
                ...
                y || ((y = new r(e[0])).sid = e[0], y.name = e[1], _.GamePlayerManager.addPlayer(y)), 
    ...
    const U = function(e) {
        function Game() {
            ...
            t.LeaderboardManager = new k, t.GameObjectManager = new A, t.vars = {}, t.msgpack = {}, 
        ...
        WebSocket.prototype.send = new Proxy(WebSocket.prototype.send, {
            apply: function(e, t, n) {
                return _.ws = t, _.sendPacket = function(e) {
                    var t = Array.prototype.slice.call(arguments, 1), n = lib_encode([ e, t ]);
                    _.ws.send(n);
                }, 1 !== _.ws.readyState || (S || (S = !0, _.ws.addEventListener("message", (function(e) {
                    var t = e.data, n = lib_decode(t);
